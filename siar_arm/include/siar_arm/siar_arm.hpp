...
class SiarArmControl{
  ...
  public:
	...
	servo_command.joint_values[i] = write_values[i];
      ...
      servo_command.command_time = time;
    ...
    void moveArm2PointInv(const geometry_msgs::Point& goal_point)
    {
      
      movelArm2PointInv(goal_point, 0);	
    }
    void movelArm2PointInv(const geometry_msgs::Point& goal_point, uint8_t n_points)
    {
      geometry_msgs::PoseStamped goal_pose;
      ...
      goal_pose.pose.orientation.x = 0;
      goal_pose.pose.orientation.y = 0;
      goal_pose.pose.orientation.z = PI;
    ...
    void moveArmHL(const uint option)  // Move the arm from to a point to another by a high level function
    {
      ...
      switch( option)
      {
	case 0: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 1: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 2: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 3: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 4: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 5: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 6: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 7: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 8: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 9: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
	case 10: J[0]=0; J[1]=0; J[2]=0; J[3]=0; J[4]=0; break; 
      }
