...
{	
	...
	public:
        ...
        float threshold_center_arm_pan;
        float threshold_center_arm_tilt;
        ...
        fire_detection_action_server_(name,boost::bind(&Point2Fire::actionCb, this,_1),false),action_name_(name)
        {
            ...
            pnh.param<float>("speed_arm_pan", speed_arm_pan,0.8);
            ...
            pnh.param<double>("throw_water_time", throw_water_time, 5.0);
        ...
        void Point2Fire::actionCb(const upo_actions::FireExtinguishGoalConstPtr &goal)
        {
            ...
            if (exe_goal)
            {
                ...
                while (!origin)
                {
                    ...
                    rto_.sleep();
                    // Stop condition around the value of origin_tilt_ref_ +/- threshold_center_arm
                ...
                while (!success)
                {
                    ...
                    while (!aux_detected)
                    {
                        ...
                        //This Condition finish the arm movement once the route through from pi/2 to -pi/2 and 0.   
                        ...
                        if (turn_complete)
                        {
                            ...
                            aux_detected = true;
                            finish_control = true;
                            ROS_ERROR("Fire Not Detected !!   finish_control = %d", finish_control);
                            break;
                        }
        ...
        void Point2Fire::cleanPubArm(void)
        {
        ...
        void Point2Fire::throw_water(){
            ...
            // ros::Rate rtcw_(ros::Duration(throw_water_time)); //por que me da error esto?
    ...
    int main(int argc, char** argv) 
    {
        ...
        Point2Fire point2fire(nh,pnh,"fire_extinguisher");
