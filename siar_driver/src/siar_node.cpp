...
bool pubOdomSrvCb(std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res)
{
  if (req.data)
  {
    publish_tf = true;
    res.message="Publishing TF";
  }
  else
  {
    publish_tf = false;
    res.message="Not publishing TF";
  }
  res.success = true;
  return true;
}
...
int main(int argc, char **argv)
{
  ...
  try
  {
    ...
    ros::ServiceServer publishTfOdomSrv = n.advertiseService("publish_tf", pubOdomSrvCb);
