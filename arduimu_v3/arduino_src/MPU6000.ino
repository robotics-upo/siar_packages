...
void MPU6000_Init(void)
{
    ...
    delay(1);
    // FS & DLPF   FS=500º/s, DLPF = 20Hz (low pass filter)
    MPU6000_SPI_write(MPUREG_CONFIG, BITS_DLPF_CFG_20HZ);  
    delay(1);
    MPU6000_SPI_write(MPUREG_GYRO_CONFIG, BITS_FS_500DPS);  // Gyro scale 500º/s (65.5 LSB/(º/s))
    delay(1);
    MPU6000_SPI_write(MPUREG_ACCEL_CONFIG, 0x08);            // Accel scale 4g (8192 LSB/g)
    delay(1);   
